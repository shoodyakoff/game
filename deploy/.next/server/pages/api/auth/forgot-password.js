...
async function handler(req, res) {
    ...
    if (req.method === "POST") {
        return (0,_server_controllers_password__WEBPACK_IMPORTED_MODULE_1__.forgotPassword)(req, res);
    }
...
var __webpack_exports__ = __webpack_require__.X(0, [974,441], () => (__webpack_exec__(3477)));
