...
async function handler(req, res) {
    ...
    if (req.method === "POST") {
        return (0,_server_controllers_auth__WEBPACK_IMPORTED_MODULE_1__.register)(req, res);
    }
...
var __webpack_exports__ = __webpack_require__.X(0, [974,446], () => (__webpack_exec__(9952)));
